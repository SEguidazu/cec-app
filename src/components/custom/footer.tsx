    ...
    <footer className="flex flex-col justify-center items-center gap-y-4 mt-6">
      ...
      >
        ...
        <ul>
          <li>
            <a
              className="inline-flex flex-row items-start justify-center text-sm gap-x-2 leading-6"
              href="tel:39820217"
            >
              <Phone color="#0A4C7D" />
              3982-0217
          ...
          <li>
            <a
              className="inline-flex flex-row items-start justify-center text-sm gap-x-2 leading-6"
              href="mailto:consultassocios@yahoo.com.ar"
            >
              <Mail color="#0A4C7D" />
          ...
          <li>
            <a
              className="inline-flex flex-row items-start justify-center text-sm gap-x-2 leading-6"
              href="https://www.instagram.com/cecliceomilitar"
              target="_blank"
            >
